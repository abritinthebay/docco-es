...
// This is the index file so it mostly just sets up the code to run.
// In this case we want to use ESModules, so are enabling that,
// then we export the default export of the core `docco.js` file.
// For a more in-depth look at the code in the other files.
require = require("@std/esm")(module, {
	mode: "all", cjs: true, await: true
});
module.exports = require("./docco.js").default;
